...
abstract class PaymentAPI {
  Future<utils.ApiReturn<models.ResponseListInvoice>> getOpenPayment(
...
class Production implements PaymentAPI {
  ...
  Future<utils.ApiReturn<models.ResponseListInvoice>> getOpenPayment(
      Map<String, dynamic> queryParameter, String token) async {
    final String method = 'getOpenPayment';
    models.ResponseListInvoice result;

    final url =
        '${config.FlavorConfig.instance.values.host}/api/Payment/GetOpenPayment';
    _log.info(method: method, message: 'url $url');
