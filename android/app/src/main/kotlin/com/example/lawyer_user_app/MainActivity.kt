package com.example.lawyer_user_app
...
import com.example.lawyer_user_app.payment.DataCustomer
...
class MainActivity : FlutterActivity(), TransactionFinishedCallback, EventChannel.StreamHandler {
    ...
    companion object {
        const val CHANNEL = "com.example.lawyer_user_app.payment_gateway";
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        EventChannel(flutterEngine?.dartExecutor?.binaryMessenger, "com.example.lawyer_user_app.payment_gateway/status").setStreamHandler(this)
    }
